# coding: utf-8
# Modify resnet50 and transfer resnet50

from keras import layers
from keras.applications.resnet50 import ResNet50
from keras.layers import Input, Activation, AveragePooling2D, Flatten, Dense
from keras.models import Model


def ResNet50_model(config):
    return ResNet50(include_top=config['model_config']['include_top'],
                    weights=None,
...
def get_resnet_final_model(img_dim, conv_dim, number_categories, weights, is_final):
    ...
    pre_model, post_model = get_resnet_pre_post_model(img_dim, conv_dim,
                                                      number_categories, model_weights=pre_post_weights)
