...
# explicitly uses convolutional and convolutional-transpose nn in the
...
# conv-transpose nn allow the latent vector to be transformed into a
...
dataroot = "/run/media/aliclotho/仓库/datasets/Kaggle-tagged-anime-illustrations/moeimouto-faces/"
...
# batch normalization nn to meet this criteria. This function is
...
# transpose nn, each paired with a 2d batch norm layer and a relu
# activation. The output of the generator is fed through a tanh function
# to return it to the input data range of $[-1,1]$. It is worth
# noting the existence of the batch norm functions after the
# conv-transpose nn, as this is a critical contribution of the DCGAN
# paper. These nn help with the flow of gradients during training. An
...
# BatchNorm2d, and LeakyReLU nn, and outputs the final probability
# through a Sigmoid activation function. This architecture can be extended
# with more nn if necessary for the problem, but there is significance
...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(dataloader, 0):
        dataload_time = time.perf_counter() - end
        ...
        train_time = time.perf_counter() - end - dataload_time
        ...
        if i % 50 == 0:
            ...
            print('\tload {:.2f}, train {:.2f}'.format(dataload_time, train_time))
