...
# %%
# Put it into together
import sys
sys.path.append('./toolbox/object_detection/MaskRCNN')
...
root = './toolbox/object_detection/MaskRCNN'
...
dataset = PennFudanDataset(f'{root}/PennFudanPed', get_transform(train=True))
dataset_test = PennFudanDataset(f'{root}/PennFudanPed',
